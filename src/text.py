...
# test=["/*hello", "helloyeas","there*/", "hello", "there"]
# # test="/*hello \nabcd  abcfdf\nthere*/ outside na to"
# test2="hello "
# testlines=prep.getlines(test)
# print(testlines)

# def get_block_comments(text:str):
#     i = 0
#     comment_buffer=''
#     if not tkc.Token.in_comment:
#         while i<len(text):
...
# for line in test:
#     print(line)
#     print(prep.get_block_comments(line))
#     print(tkc.Token.block_comment_buffer)

# print(tkc.Token.block_comment_buffer)
# print(test[0:2])
# # comment=''
# # for line in testlines:
# #     comment+=tokenize_block_comments(line)
# # print(prep.get_identifier("@"))
...
# print(prep.get_block_comments(test))
